...
Usage : lancer_lot_e.py <numéro de lot>
"""
import json
import os
import sys
...
num = sys.argv[1]
index = json.load(open(os.path.join(ROOT, "work/batches/E/domaines_lots.json")))
d = index[num]
...
Traduis intégralement /home/goss/ark-fr/work/batches/E/in_{num}.json et écris le \
résultat dans /home/goss/ark-fr/work/batches/out/E_{num}.json : un JSON \
